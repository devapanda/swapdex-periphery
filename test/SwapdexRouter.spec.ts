...
import { swapdexFixture } from './shared/fixtures'
...
describe('SwapdexRouter', () => {
  ...
  beforeEach(async function() {
    const fixture = await loadFixture(swapdexFixture)
    token0 = fixture.token0
    token1 = fixture.token1
    WETH = fixture.WETH
    WETHPartner = fixture.WETHPartner
    factory = fixture.swapdexFeactory
  ...
  it('getAmountOut', async () => {
    ...
    await expect(router.getAmountOut(bigNumberify(0), bigNumberify(100), bigNumberify(100), bigNumberify(30))).to.be.revertedWith(
      'SwapdexLibrary: INSUFFICIENT_INPUT_AMOUNT'
    )
  ...
  it('getAmountIn', async () => {
    ...
    await expect(router.getAmountIn(bigNumberify(0), bigNumberify(100), bigNumberify(100), bigNumberify(30))).to.be.revertedWith(
      'SwapdexLibrary: INSUFFICIENT_OUTPUT_AMOUNT'
    )
...
describe('fee-on-transfer tokens', () => {
  ...
  beforeEach(async function() {
    ...
    await fixture.swapdexFeactory.createPair(DTT.address, WETH.address)
    const pairAddress = await fixture.swapdexFeactory.getPair(DTT.address, WETH.address)
    pair = new Contract(pairAddress, JSON.stringify(ISwapdexPair.abi), provider).connect(wallet)
  })
...
describe('fee-on-transfer tokens: reloaded', () => {
  ...
  beforeEach(async function() {
    ...
    // make a DTT<>WETH pair
    await fixture.swapdexFeactory.createPair(DTT.address, DTT2.address)
    const pairAddress = await fixture.swapdexFeactory.getPair(DTT.address, DTT2.address)
  })
